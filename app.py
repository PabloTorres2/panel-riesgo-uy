...
if not enlace_radar:
    st.info("🛰️ El enlace con el satélite de radar está temporalmente congestionado. Los mapas se mostrarán sin la capa animada.")
...
with tab_fuego:
    ...
    with col3:
        ...
        fig_fuego = px.scatter(df_fuego, x="PSE", y="RFO", color="Categoria", hover_name="Ciudad",
            color_discrete_map={"Mínimo": "#10B981", "Bajo": "#3B82F6", "Medio": "#FBBF24", "Alto": "#F97316", "Crítico": "#DC2626",
